...
LOG_MODULE_REGISTER(liveMap,CONFIG_LOG_DEFAULT_LEVEL);
...
{
    LOG_INF("LiveMap::onViewLoad - START");
    ...
    LOG_INF("LiveMap::onViewLoad - COMPLETE");
}
...
void LiveMap::onViewDidAppear()
{
    ...
    {
        LiveMap* instance = (LiveMap*)lv_timer_get_user_data(timer);
        instance->Update();
    },
    100,
    this);
